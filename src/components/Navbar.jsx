    ...
    return (
        <>
            <div className="flex flex-col md:flex-row w-screen justify-around items-center mt-8 mb-40 gap-4 md:gap-0 px-8">
                <div className="flex w-full md:w-[60%] space-x-12 items-center">
                    <a href="/" className="hidden md:flex"><img src="logo.png" alt="Freedom" className="rounded-full border-[1px] p-1 w-20"/></a>
                    <div className="flex flex-col w-full text-center">
                        <h1 className="border-b-2 border-dotted text-4xl p-0.5 mb-2"><a href="/" className="hover:border-b-2">STUDY-ARCHIVE</a></h1>
                        <h2 className="">Notes and materials by those who already finished it</h2>
                    </div>
                </div>
